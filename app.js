...
// var q = "Please enter your gender";
// var ans = prompt(q, )
// if (ans === "male"){
...
//  if (a > b){
//     alert("The first number is greater then the second number")
//  }

//  if (a < b){
//     alert("The second number is greater then the first number")
//  }
...
// let a = ["english", "arabic", "french"]
// var b = prompt("Enter a language", "english, arabic, french")
// for (let i = 0; i < a.length; i++){
